...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div className="w-full bg-zinc-950 text-zinc-100 border-t border-zinc-800 mx-auto md:px-32 px-5 sm:py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-5 gap-6 sm:gap-8">
          ...
          >
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-start">
                <svg className="w-4 h-4 text-zinc-400 mt-1 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center">
                <svg className="w-4 h-4 text-zinc-400 mr-3 flex-shrink-0" fill="currentColor" viewBox="0 0 20 20">
          ...
          >
            <h2 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Services</h2>
            <div className="space-y-2 text-sm">
              <span className="block py-1">Road Freight</span>
              <span className="block py-1">Air Cargo</span>
              <span className="block py-1">Sea Freight</span>
              <span className="block py-1">Rail Freight</span>
              <span className="block py-1">Warehousing</span>
              <span className="block py-1">Last-Mile Delivery</span>
            </div>
          </div>
          ...
          <div 
            className="sm:col-span-1 lg:col-span-1 xl:col-span-1"
          >
            <h2 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Emotrans</h2>
            <div className="space-y-2 text-sm">
          ...
          <div 
            className="sm:col-span-2 lg:col-span-1 xl:col-span-1"
          >
            <h2 className="text-white font-bold text-base sm:text-lg mb-3 sm:mb-4">Our Social Media</h2>
            <div className="space-y-2 text-sm">
            ...
            <form onSubmit={handleNewsletterSubmit} className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2.5 border border-[#41a8d1] rounded focus:outline-none focus:border-[#41a8d1] text-sm text-white bg-zinc-900 placeholder-zinc-500"
                  required
                />
              </div>
              <button 
